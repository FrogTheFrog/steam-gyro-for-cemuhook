...
export class FilterComponent implements OnInit, OnDestroy {
    ...
    public filterData: Filters = {
        ...
        "kalman-1d": {
            inputStep: [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
            names: [
                "[Accel] Process noise [R]",
                "[Accel] Measurement noise [Q]",
                "[Accel] State vector [A]",
                "[Accel] Measurement vector [C]",
                "[Gyro] Process noise [R]",
                "[Gyro] Measurement noise [Q]",
                "[Gyro] State vector [A]",
                "[Gyro] Measurement vector [C]",
            ],
            selectName: "Kalman 1D",
            validators: [
                [Validators.required],
                [Validators.required],
                [Validators.required],
